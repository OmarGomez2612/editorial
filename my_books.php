...
<section class="show-products">
   ...
   <?php
      $select_products = $conn->prepare("
         ...
         WHERE pay.user_id = ? AND p.type_id = 1
      ");
   ...
   ?>
      <div class="box">
         ...
         <div class="flex-btn">
            <a href="read_book.php?id=<?= $fetch_products['id']; ?>" class="option-btn">LEER</a>
         </div>
      </div>
   <?php
         }
   ...
   ?>
      <div style="text-align: center; margin-top: 20px;">
         <?php if($user_id == ''){ ?>
            <p class="empty"><a href="user_login.php" style="text-decoration: none; color: inherit;">INICIA SESIÓN PARA CONOCER TUS LIBROS</a></p>
         <?php } else { ?>
            <p class="empty"><a href="shop.php" style="text-decoration: none; color: inherit;">CONOCE NUESTRA VARIEDAD DE LIBROS</a></p>
         <?php } ?>
      </div>
   <?php
      }
